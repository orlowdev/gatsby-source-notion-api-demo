    ...
    <Layout>
      <section className="pt-28 pb-20 px-5 text-center bg-violet-500">
        <h1 className="text-5xl lg:text-7xl leading-loose font-black">
          <a href="https://gatsbyjs.com">
            <span className="bg-violet-400 px-4 py-2 rounded-md shadow-md">
              Gatsby
            </span>
          </a>{" "}
          +{" "}
          <a href="https://notion.so">
            <span className="bg-gray-400 px-4 py-2 rounded-md shadow-md">
              Notion
            </span>
          </a>{" "}
          ={" "}
          <a href="https://www.npmjs.com/package/gatsby-source-notion-api">
            <span
              className="bg-rose-400 px-4 py-2 rounded-md shadow-md"
              role="img"
              aria-label="heart"
            >
              ♥️
      ...
      <div className="prose prose-purple px-5 self-center">
        ...
        <p>
          ...
          <strong>0</strong> lines of CSS code written.
        </p>

        <p>
          Thanks to simple and convenient API provided by MarkdownRemark and
          MDX, you can query Notion pages with <code>mardownRemark</code> or{" "}
          <code>mdx</code> if you use them. For your convenience, all Notion
          page properties are put into <strong>frontmatter</strong>.
        </p>
        ...
        <p>
          ...
          <code>unsupported</code>. They will hopefully become available later
          on. For now, <code>gatsby-source-notion-api</code> marks places for

	...
	return (
		<Layout>
			<div className="px-12 pt-24 pb-6 lg:px-32 lg:py-12 border-purple-500">
				<h1 className="text-4xl text-gray-800 text-center mb-10">{page.frontmatter.title}</h1>

				<div className="flex flex-col text-xs md:flex-row space-y-5 md:space-y-0 justify-between align-middle">
					<div>
						<p className="mb-2">Status:</p>
						<Label name={page.frontmatter.status.name} color={page.frontmatter.status.color} />
					</div>
